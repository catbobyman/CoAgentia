...
export type Status5 = 'ok' | 'offline' | 'timeout';
...
export type Status6 = 'active' | 'merged' | 'conflicted' | 'cleaned';
...
export interface CoAgentiaContracts {
  ...
  TaskMergeAccepted?: TaskMergeAccepted;
  TaskPatch?: TaskPatch;
 ...
 */
export interface TaskMergeAccepted {
  status: Status4;
  task_id: TaskId22;
}
/**
