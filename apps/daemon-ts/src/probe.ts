 ...
 * `claude.cmd` 绝对路径；which = adapters/codex_cmdline 共享单点，测试仍经 opts.which 注入）。
 * DetectedRuntime 形状（runtime/installed/models[/skills]）在 contracts。
 *
...
import { which as defaultWhich } from './adapters/codex_cmdline.ts';
