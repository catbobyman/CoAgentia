...
1. 审阅并提交当前未提交的 M1 hardening 变更。
2. 在干净环境完成真实双 Agent OAuth 冷启动复验。
3. 分批清理 Pyright 的 109 个既有错误。
4. 决定并执行 `m1-impl` 合并主线，随后推进 B2b/B3 或 M2。
5. 补齐附件渲染等后续产品能力，并同步非交接类计划文档中的旧状态。
