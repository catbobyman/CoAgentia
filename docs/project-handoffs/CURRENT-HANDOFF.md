...
| 测试基线 | 后端 **943 passed / 4 skipped**（`uv run pytest -q`，M6b 阶段 4 审计修复起）· web vitest **349** · pyright **0**（并入 `pnpm typecheck`）· ruff 干净 · `pnpm gen` 确定 · web build 绿 |
