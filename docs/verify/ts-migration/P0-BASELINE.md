...
> 制品基线 tree：`867458147481d07420ceb72c774f83031e42b1a1`
> 当前执行分支：`main`
> 证据日期：2026-07-20
...
| `pnpm verify:p0` | tools 29/29；target mutants 8/8；ledger mutants 45/45；inventory mutants 18/18；authority mutants 35/35 | ✅ |
